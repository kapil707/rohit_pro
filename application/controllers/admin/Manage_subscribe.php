...
class Manage_subscribe extends CI_Controller {
	...
	var $Page_title = "Manage Subscribe";
	var $Page_name  = "manage_subscribe";
	var $Page_view  = "manage_subscribe";
	var $Page_menu  = "manage_subscribe";
	var $page_controllers = "manage_subscribe";
	var $Page_tbl   = "tbl_subscribe";
