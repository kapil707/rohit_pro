        ...
        <div class="container-fluid cnt_fluid_wrapper">
            ...
            <div class="right-nav">
                ...
                <nav class="navbar" id="nav_hlder_js_mbl">
                    <img src="<?php echo base_url() ?>assets/website/assets/img/navigation-icon.png" class="toggle_btn_menu" alt="<?php echo $title2; ?>" id="mbl_opn_mn_js" />
                    <div class="navbar-collapse nav" id="myNavbar">
                        <!--collapse -->
                        <div class="close_menu_div" id="close_mbl_menu_btn">
                            <img src="<?php echo base_url() ?>assets/website/assets/img/toggle-button-close.png" alt="<?php echo $title2; ?>" class="toggle_btn_menu_close" />
                            <p>Menu</p>
                        </div>
