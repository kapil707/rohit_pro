<?php include('../../../../header.php') ?>
		...
		<img src="<?php echo $url?>assets/img/Office-Space-1.jpg" title="Office Space | Spectrum Metro" alt=" Office Space Sector 75  Noida Spectrum Metro">
...
Professional Hub </h2></div-->
	...
	<div class="container-fluid cnt_fluid_wrapper">
		...
		<div class="msection wow fadeInTop animated animated">
			...
			<div class="msection-contant">
			 <h2 title="Floor Plan">floor plan</h2>
				<!--End of Header  Part-->
    ...
    <div class="carousel-inner docs-pictures" role="listbox">
       ...
       <div class="item active" >
		...
		<img data-original="<?php echo $url?>assets/img/office-space-floor-plan-1.jpg" src="<?php echo $url?>assets/img/office-space-floor-plan-1.jpg" title="Office Space | Spectrum Metro" alt="fplan-1"></a>
    </div>
	   	
       <div class="item " >
        <a class="group1" href="javascript:;">
		<img data-original="<?php echo $url?>assets/img/office-space-floor-plan-2.jpg" src="<?php echo $url?>assets/img/office-space-floor-plan-2.jpg" title="Office Space | Spectrum Metro" alt="fplan-1"></a>
    </div>
	   	
       <div class="item " >
        <a class="group1" href="javascript:;">
		<img data-original="<?php echo $url?>assets/img/office-space-floor-plan-3.jpg" src="<?php echo $url?>assets/img/office-space-floor-plan-3.jpg" title="Office Space | Spectrum Metro" alt="fplan-1"></a>
    </div>
